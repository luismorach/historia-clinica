...
public class Registrar extends javax.swing.JDialog {
    ...
    public Registrar(java.awt.Frame parent, boolean modal) {
        ...
        Registrar.lblID.setVisible(false);
    }
    ...
    private void registrarTodo() {
        ...
        if (pacientes.ficha_identificacion.Opciones.verificaNumControl(this.txtNumControl.getText())) {
            ErrorAlert a = new ErrorAlert(null, true);
            ErrorAlert.msj1.setText("El No. CONTROL que intentas registrar");
            ...
            fichaIdent.setId_paciente(Integer.parseInt(Registrar.lblID.getText()));
            ...
            ant_heredo.setId(Integer.parseInt(Registrar.lblID.getText()));
            ...
            ant_no_pat.setId(Integer.parseInt(Registrar.lblID.getText()));
            ...
            ant_gin_obst.setId(Integer.parseInt(Registrar.lblID.getText()));
            ...
            ant_pat.setId(Integer.parseInt(Registrar.lblID.getText()));
            ...
            sig_vitales.setId(Integer.parseInt(Registrar.lblID.getText()));
            ...
            generarl.setId(Integer.parseInt(Registrar.lblID.getText()));
            ...
            if (errores == 0) {
                ...
                pacientes.ficha_identificacion.Opciones.selecionaFila(Registrar.lblID.getText());
                pacientes.ficha_identificacion.Opciones.extraerID();
            }
        }
    }
