...
public class Registrar extends javax.swing.JDialog {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if (this.txtNumControl.getText().length() == 0 || this.txtDescripcion.getText().length() == 0
            ...
            s.setId(Integer.parseInt(Registrar.lblID.getText()));
            ...
            if (Opciones.registrar(s)) {
                ...
                Opciones.listar("");
                Opciones.selecionaFila(Registrar.lblID.getText());

                this.dispose();

                SuccessAlert a = new SuccessAlert(null, true);
                SuccessAlert.msj1.setText("Consulta registrada con exito.");
                SuccessAlert.msj2.setVisible(false);
                SuccessAlert.msj3.setVisible(false);
                a.setVisible(true);

                principal.Principal.id_consulta = Registrar.lblID.getText();
