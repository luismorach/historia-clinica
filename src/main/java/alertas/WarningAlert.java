...
public class WarningAlert extends javax.swing.JDialog {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if (WarningAlert.lblTipo.getText().equals("Eliminar Paciente")) {
            eliminarPaciente();
        }

        if (WarningAlert.lblTipo.getText().equals("Eliminar Consulta")) {
            eliminarConsulta();
        }

        if (WarningAlert.lblTipo.getText().equals("Eliminar Usuario")) {
            eliminarUsuario();
        }

        if (WarningAlert.lblTipo.getText().equals("Salir")) {
            salirAplicacion();
        }
    ...
    private void eliminarPaciente() {
        int errores = 0;
        int numControl = Integer.parseInt(WarningAlert.lblId.getText());
        ...
        if (errores == 0) {
            ...
            SuccessAlert.msj1.setText("Registro eliminado con exito.");
    ...
    private void eliminarConsulta() {
        ...
        s.setId(Integer.parseInt(WarningAlert.lblId.getText()));
    ...
    private void eliminarUsuario() {
        ...
        if (usuarios.Opciones.eliminar(s)) {
            ...
            this.dispose();
            SuccessAlert a = new SuccessAlert(null, true);
            SuccessAlert.msj1.setText("Usuario eliminado con exito.");
            SuccessAlert.msj2.setVisible(false);
            SuccessAlert.msj3.setVisible(false);
            a.setVisible(true);
        }
